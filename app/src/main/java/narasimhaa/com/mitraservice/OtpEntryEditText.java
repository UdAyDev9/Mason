...
public class OtpEntryEditText extends androidx.appcompat.widget.AppCompatEditText {
    ...
    public OtpEntryEditText(Context context, AttributeSet attrs, int defStyleAttr) {
