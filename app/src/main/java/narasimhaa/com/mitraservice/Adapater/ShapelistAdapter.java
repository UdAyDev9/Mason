...
import narasimhaa.com.mitraservice.ShapeListActivity;


public class ShapelistAdapter extends RecyclerView.Adapter<ShapelistAdapter.SizeBrandsViewHolder> {

    List<ServicesDataItemSize> list;
    Context context;

    public ShapelistAdapter(List<ServicesDataItemSize> list, Context context) {
        this.list = list;
    ...
    public SizeBrandsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.item_shapelist, parent, false);
    ...
    public class SizeBrandsViewHolder extends RecyclerView.ViewHolder {
        ...
        private void alertForDeleteShape(){

            AlertDialog.Builder builder = new AlertDialog.Builder(context);
            builder.setTitle("Delete Shape");
            builder.setMessage("Are you sure, you want to delete this Shape?");
            builder.setCancelable(false);
            builder.setPositiveButton("Yes", (dialog, which) -> {

                ((ShapeListActivity) context).onClickDeleteShape(list.get(getAdapterPosition()).getSERVICE_NAME());
