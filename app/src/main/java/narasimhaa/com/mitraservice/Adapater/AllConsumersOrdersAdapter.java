        ...
        try {
            ...
            switch (list.get(position).getSTATUS()){
                ...
                case MyUtilities.ORDER_STATUS_PENDING :
                    ...
                    holder.tv_order_status.setTextColor(ContextCompat.getColor(context, R.color.orange));
                    break;
                case MyUtilities.ORDER_STATUS_QUOTED:
                    ...
                    holder.tv_order_status.setTextColor(ContextCompat.getColor(context, R.color.colorPrimary));
                    break;
                case MyUtilities.ORDER_STATUS_PROCESSED:
                    ...
                    holder.tv_order_status.setTextColor(ContextCompat.getColor(context, R.color.yellow));
                    break;
                case MyUtilities.ORDER_STATUS_DELIVERED:
                    ...
                    holder.tv_order_status.setTextColor(ContextCompat.getColor(context, R.color.green));
                    break;
                default:
                    return;
