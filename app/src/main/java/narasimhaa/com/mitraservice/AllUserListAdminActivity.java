...
public class AllUserListAdminActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    ...
    public void getData(String service,String city,String businessType) throws ParseException {
        ...
        if (ll_status_type.getText().toString().equalsIgnoreCase("Retailer")){

            userCall = apiInterface.getAllUsers("Retailer",strDate);
        }else {
            userCall = apiInterface.getAllUsers(ll_status_type.getText().toString(),strDate);
        }
    ...
    public void updateStatus(String email,String ll_status_type) {
        ...
        paramObject.addProperty("STATUS", ll_status_type);
    ...
    public void onClickUpdateDealerActiveState(String email,String ll_status_type){{


        updateStatus(email,ll_status_type);

        //MyUtilities.showToast(AllUserListAdminActivity.this,email + "   " +ll_status_type);
    ...
    private void initViews() {
        ll_status_type = findViewById(R.id.ll_user_type);
        date = findViewById(R.id.date);
        ll_status_type.setText(getResources().getStringArray(R.array.user_types_array)[0]);
        ...
        ll_status_type.setAdapter(new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.user_types_array)));
