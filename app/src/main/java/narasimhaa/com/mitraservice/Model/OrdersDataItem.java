...
public class OrdersDataItem {
    ...
    public void setN_ITEMS (String N_ITEMS)
    {
    ...
    public String getSIZE_QNTY ()
    {
        return SIZE_QNTY;
    }

    public void setSIZE_QNTY (String SIZE_QNTY)
    {
        this.SIZE_QNTY = SIZE_QNTY;
    }
